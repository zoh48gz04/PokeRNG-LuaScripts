...
local tempInitialSeed, advances = 0, 0
...
function showMovesAndPP(movesValue1, movesValue2, ppValue, buffer)
 ...
 buffer:print(string.format("Move: %s\tPP: %d\n", strPadding(moveNamesList[move1Index <= 354 and move1Index + 1 or 1], 14), PPmove1))
 buffer:print(string.format("Move: %s\tPP: %d\n", strPadding(moveNamesList[move2Index <= 354 and move2Index + 1 or 1], 14), PPmove2))
 buffer:print(string.format("Move: %s\tPP: %d\n", strPadding(moveNamesList[move3Index <= 354 and move3Index + 1 or 1], 14), PPmove3))
 buffer:print(string.format("Move: %s\tPP: %d\n\n\n", strPadding(moveNamesList[move4Index <= 354 and move4Index + 1 or 1], 14), PPmove4))
end
...
function getRoamerInfo()
 ...
 local roamerIVsValue = emu:read32(roamerAddr) & 0xFF
...
function getInfoInput(buffer)
 ...
 prevKeyInfo = key
 buffer:print(string.format("Mode: %s\t(Change mode pressing R + Right or R + Left)\n\n", strPadding(infoMode[infoIndex], 19)))
end
...
emu:reset()
printGameInfo()
--callbacks:add("start", printGameInfo)
